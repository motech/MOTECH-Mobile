...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (7645645756876,0,254657657567688,'childRegNum','ALPHANUM',20,true,'2010-01-08 14:54:14','2010-01-08 15:22:53');
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (7658545887996,0,254657657567688,'regDate','DATE',10,true,'2010-01-08 14:54:14','2010-01-08 15:22:53');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (12353635757884,0,254657657567688,'childGender','GENDER',20,true,'2010-01-08 14:54:14','2010-01-08 15:22:53');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (24575686567567,0,254657657567688,'nhisExp','DATE',10,true,'2010-01-08 14:54:14','2010-01-08 15:22:53');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (53475686867887,0,254657657567688,'motherRegNum','ALPHANUM',20,true,'2010-01-08 14:54:14','2010-01-08 15:22:53');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (92366865767568,0,254657657567688,'childFirstName','ALPHA',20,true,'2010-01-08 14:54:14','2010-01-08 15:22:54');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (359809010998245,0,785688106549491,'FacilityId','NUMERIC',10,true,'2009-12-18 11:04:20','2010-01-08 15:22:54');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`length`,`required`,`date_created`,`last_modified`) values (447617060511586,0,785688106549491,'Diagnosis','NUMERIC',3,true,'2009-12-18 11:04:20','2010-01-08 15:22:54');
