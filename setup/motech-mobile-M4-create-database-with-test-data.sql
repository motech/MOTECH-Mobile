...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (879874663983216,0,785739375640097,'secondDiagnosis','NUMERIC',2,false,'2010-02-03 10:29:14','2010-02-03 10:29:14');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (695474663923336,0,785739375640098,'secondDiagnosis','NUMERIC',2,false,'2010-02-03 10:29:14','2010-02-03 10:29:14');
