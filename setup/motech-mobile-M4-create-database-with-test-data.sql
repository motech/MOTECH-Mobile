...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (92366865767568,0,254657657567688,'firstName','ALPHA',20,true,'2010-01-08 14:54:14','2010-01-08 15:22:54');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (24575686567567,0,254657657567688,'nhisExpiration','DATE',10,true,'2010-01-08 14:54:14','2010-01-08 15:22:53');
