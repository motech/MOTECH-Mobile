...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (447617060511588,0,785688106549491,'newCase','CASESTATUS',1,true,'2009-12-18 11:04:20','2010-01-08 15:22:54');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (324546463984530,0,785739375640099,'facilityId','NUMERIC',20,true,'2010-02-03 10:29:14','2010-02-03 10:29:14');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (324546463984534,0,785739375640099,'firstName','ALPHNUM',20,false,'2010-02-03 10:29:14','2010-02-03 10:29:14');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (434546463984506,0,785739375640001,'ITN','ALPHANUM',3,true,'2010-02-03 10:29:14','2010-02-03 10:29:14');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (879874663983214,0,785739375640097,'newCase','CASESTATUS',1,true,'2010-02-03 10:29:14','2010-02-03 10:29:14');
...
insert into `incoming_message_form_parameter_definition` (`id`,`obj_vesion`,`incoming_message_form_definition_id`,`name`,`parameter_type`,`lenght`,`required`,`date_created`,`last_modified`) values (695474663923334,0,785739375640098,'newCase','CASESTATUS',1,true,'2010-02-03 10:29:14','2010-02-03 10:29:14');
